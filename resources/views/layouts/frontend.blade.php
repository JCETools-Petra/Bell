...
<body class="d-flex flex-column min-vh-100">
    ...
    <footer class="footer mt-auto">
        <div class="container text-center">
            <p class="mb-0">&copy; {{ date('Y') }} Bell Hotel Merauke. All Rights Reserved.</p>
        </div>
    </footer>
    ...
    <script>
        // Inisialisasi Flatpickr pada input dengan kelas 'datepicker'
        flatpickr(".datepicker", {
            dateFormat: "d-m-Y", // Format tanggal Indonesia
