    ...
    <div class="relative bg-gray-900 pt-24 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            <nav class="flex justify-center text-sm text-gray-400 mb-4">
                <a href="{{ route('affiliate.dashboard') }}" class="hover:text-brand-gold transition-colors">Dashboard</a>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                        ...
                        <div class="p-6 bg-gray-50 flex flex-col items-center justify-center text-center border-b border-gray-100">
                            ...
                            @else
                                <div class="w-20 h-20 bg-red-100 text-brand-red rounded-2xl flex items-center justify-center mb-4 shadow-sm">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-lg border-t-4 border-brand-gold overflow-hidden">
                        <div class="p-6 md:p-8">
                            ...
                            @if ($errors->any())
                                <div class="mb-6 p-4 bg-red-50 border-l-4 border-brand-red text-red-700 text-sm rounded-r-lg">
                            ...
                            <form action="{{ route('affiliate.special_mice.store') }}" method="POST" id="bookingForm" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="event_name" value="{{ old('event_name') }}" required 
                                               class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors" 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="text" name="check_in_date" class="datepicker w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors" 
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" id="displayPriceInput" required 
                                                       class="w-full bg-white border-0 ring-1 ring-gray-200 rounded-lg pl-16 pr-4 py-3 text-lg font-bold text-gray-900 focus:ring-2 focus:ring-brand-gold placeholder-gray-300" 
                                                       placeholder="0">
                                ...
                                <div>
                                    ...
                                    <textarea name="note" rows="3" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors" placeholder="Request khusus layout, menu, dll...">{{ old('note') }}</textarea>
                                </div>

                                {{-- Submit --}}
                                <button type="submit" class="w-full bg-gray-900 hover:bg-brand-gold text-white hover:text-gray-900 font-bold py-4 rounded-xl transition-all duration-300 shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center gap-2">
            ...
            <div class="relative w-full max-w-5xl h-[85vh] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col">
                ...
                <div class="bg-gray-900 px-6 py-4 flex justify-between items-center shrink-0">
                    <h3 class="text-white font-bold flex items-center gap-2">
                        <i class="fas fa-book-open text-brand-gold"></i> {{ $miceKit->title }}
                    </h3>
