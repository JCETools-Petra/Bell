...
@section('seo_title', 'Digital MICE Kit - Sora Hotel Merauke')
                    ...
                    @foreach ($miceKits as $kit)
                        ...
                        <div class="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col h-full">
                            ...
                            <div class="relative h-56 bg-gray-100 overflow-hidden group-hover:bg-gray-200 transition-colors flex items-center justify-center">
                                ...
                                @else
                                    <div class="text-center p-6">
                                        @if($isPdf)
                                            <i class="fas fa-file-pdf text-5xl text-brand-red mb-2 block drop-shadow-sm"></i>
                                ...
                                <div class="absolute top-4 right-4">
                                    ...
                                    @elseif($isPdf)
                                        <span class="bg-brand-red/90 text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide shadow-sm backdrop-blur-sm">PDF</span>
                                    @else
                            ...
                            <div class="p-6 flex flex-col flex-grow">
                                <h5 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-brand-gold transition-colors line-clamp-1" title="{{ $kit->title }}">
                                    {{ $kit->title }}
                                </h5>
