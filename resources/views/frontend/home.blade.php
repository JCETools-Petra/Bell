                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm border-0">
                                ...
                                <div class="card-body d-flex flex-column p-4">
                                    ...
                                    <p class="card-price text-gold fw-bold mb-3">Rp {{ number_format($room->price, 0, ',', '.') }} <span class="text-muted small fw-normal">/ night</span></p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm border-0">
                                ...
                                <div class="card-body d-flex flex-column p-4">
                                    ...
                                    <p class="mb-3 text-muted"><i class="fas fa-users text-gold me-2"></i> Capacity: <strong>{{ $mice->capacity_theatre ?? $mice->capacity_classroom }}</strong></p>
