...
@section('seo_title', 'Apa itu Affiliate? - Sora Hotel Merauke')
@section('meta_description', 'Pelajari cara kerja program affiliate Sora Hotel Merauke. Dapatkan komisi dengan merekomendasikan hotel kami.')
...
@section('content')
    ...
    <div class="relative bg-gray-900 pt-32 pb-20 sm:pt-40 sm:pb-24 overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-20 text-center">
            <span class="text-brand-gold font-bold uppercase tracking-[0.2em] text-sm mb-4 block animate-fade-in-up">Partnership Program</span>
            <h1 class="text-4xl md:text-6xl font-heading font-bold text-white mb-6 leading-tight animate-fade-in-up delay-100">
                Grow With <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-600">Sora Hotel</span>
            </h1>
            ...
            <div class="mt-10 animate-fade-in-up delay-300 flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('affiliate.register.create') }}" class="bg-brand-gold hover:bg-brand-gold text-gray-900 font-bold py-3.5 px-8 rounded-full transition-all transform hover:-translate-y-1 shadow-lg shadow-yellow-500/20">
                    Gabung Sekarang
                </a>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div class="lg:w-1/2">
                    ...
                    <p class="text-gray-600 text-lg leading-relaxed mb-6 text-justify">
                        Program Affiliate Sora Hotel Merauke adalah sebuah peluang kemitraan di mana Anda bisa mendapatkan penghasilan tambahan (komisi) hanya dengan mempromosikan layanan kami kepada orang lain.
                    </p>
                    ...
                    <div class="bg-gray-50 border-l-4 border-brand-gold p-6 rounded-r-xl">
                        <p class="text-gray-800 font-medium italic">
                            "Tidak perlu modal, tidak perlu stok barang. Cukup rekomendasikan kenyamanan Sora Hotel, dan nikmati hasilnya."
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="how-it-works" class="py-20 bg-gray-50 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="text-brand-gold font-bold uppercase tracking-wider text-xs">Simple Steps</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                ...
                {{-- Step 2 --}}
                <div class="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-shadow text-center group border border-gray-100 relative">
                    <div class="w-20 h-20 mx-auto bg-brand-gold text-white rounded-2xl flex items-center justify-center text-3xl font-bold mb-6 shadow-lg shadow-yellow-500/30 group-hover:scale-110 transition-transform">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:bg-white hover:shadow-lg transition-all">
                    <i class="fas fa-money-bill-wave text-3xl text-brand-gold mb-4"></i>
    ...
    {{-- 5. CTA FINAL --}}
    <section class="py-20 bg-brand-gold relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
            ...
            <p class="text-gray-800 text-lg max-w-2xl mx-auto mb-10 font-medium">
                Jangan lewatkan kesempatan ini. Bergabunglah dengan komunitas partner Sora Hotel Merauke sekarang juga.
            </p>
