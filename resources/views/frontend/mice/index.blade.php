...
@section('seo_title', 'MICE Facilities - Sora Hotel Merauke')
...
@section('content')
    ...
    <div class="relative bg-gray-900 py-24 sm:py-32 overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span class="text-brand-secondary font-bold uppercase tracking-widest text-sm mb-2 block animate-fade-in-up">Business & Events</span>
            <h1 class="text-4xl md:text-6xl font-heading font-bold text-white mb-6 tracking-tight animate-fade-in-up delay-100">
                MICE <span class="text-brand-secondary">Facilities</span>
            </h1>
            <p class="text-gray-300 text-lg max-w-3xl mx-auto font-light leading-relaxed animate-fade-in-up delay-200">
                Tempat sempurna untuk kesuksesan acara Anda. Dari pertemuan bisnis privat hingga konferensi berskala besar dan pernikahan impian, Sora Hotel menyediakan fasilitas modern dengan pelayanan bintang 4.
            </p>
        </div>
    </div>
                    ...
                    @foreach($miceRooms as $index => $room)
                        ...
                        <div class="group relative bg-gray-50 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col {{ $index % 2 == 0 ? 'lg:flex-row' : 'lg:flex-row-reverse' }} lg:col-span-2 h-auto lg:h-[400px]">
                            ...
                            <div class="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center relative">
                                ...
                                <h3 class="text-2xl md:text-3xl font-heading font-bold text-gray-900 mb-4 group-hover:text-brand-gold transition-colors">
                                    {{ $room->name }}
                                </h3>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-8">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-full bg-yellow-100 text-brand-gold flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-full bg-blue-100 text-admin-secondary flex items-center justify-center flex-shrink-0">
                                ...
                                <a href="{{ route('mice.show', $room->slug ?? $room->id) }}" 
                                   class="inline-flex items-center text-gray-900 font-bold hover:text-brand-gold transition-colors group/link">
    ...
    <section class="bg-gray-900 py-20 relative overflow-hidden">
        {{-- Pattern --}}
        <div class="absolute top-0 right-0 w-64 h-64 bg-brand-gold rounded-full filter blur-[100px] opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('contact.index') }}" class="bg-brand-gold hover:bg-brand-gold text-gray-900 font-bold py-3.5 px-8 rounded-full transition-all transform hover:-translate-y-1 shadow-lg shadow-yellow-500/20">
                    Minta Penawaran
                </a>
