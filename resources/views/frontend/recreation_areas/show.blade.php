                ...
                <div class="modern-gallery">
                    @foreach($recreationArea->images as $image)
                        <div class="gallery-card">
                            {{-- PERBAIKAN: Logika Path Gambar Pintar untuk Lightbox dan Thumbnail --}}
                            <a href="{{ Str::contains($image->path, 'storage/') ? asset($image->path) : asset('storage/' . str_replace('public/', '', $image->path)) }}"
