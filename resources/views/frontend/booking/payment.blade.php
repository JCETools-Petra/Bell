...
@section('seo_title', 'Selesaikan Pembayaran - Sora Hotel Merauke')
    ...
    <div class="min-h-screen bg-gray-50 py-20 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="text-center mb-10 pt-10">
                <span class="text-brand-gold font-bold uppercase tracking-[0.2em] text-xs mb-2 block">Secure Checkout</span>
            ...
            <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-gray-100">
                ...
                <div class="w-full lg:w-5/12 bg-gray-50 p-8 border-b lg:border-b-0 lg:border-r border-gray-200">
                    <h3 class="text-lg font-bold text-gray-900 mb-6 flex items-center gap-2">
                        <i class="fas fa-receipt text-brand-gold"></i> Ringkasan Pesanan
                    </h3>
                    ...
                    <div class="rounded-2xl overflow-hidden shadow-sm mb-6 relative group h-48">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                            @if($booking->room)
                                <span class="bg-admin-secondary text-white text-[10px] font-bold px-2 py-1 rounded uppercase mb-1 inline-block">Room Booking</span>
                    ...
                    <div class="mt-8 p-4 bg-white rounded-xl border border-yellow-200 shadow-sm">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-xl font-bold text-brand-gold">Rp {{ number_format($booking->total_price, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-7/12 p-8 lg:p-12 bg-white flex flex-col justify-center items-center text-center">
                    ...
                    <div class="w-24 h-24 bg-yellow-50 rounded-full flex items-center justify-center mb-6 animate-pulse">
                        <i class="fas fa-wallet text-4xl text-brand-gold"></i>
                    </div>
                    ...
                    <div class="w-full max-w-sm space-y-4">
                        ...
                        <button id="pay-button" class="w-full bg-gray-900 hover:bg-brand-gold text-white hover:text-gray-900 font-bold py-4 px-8 rounded-xl transition-all shadow-lg transform hover:-translate-y-1 flex items-center justify-center gap-3">
