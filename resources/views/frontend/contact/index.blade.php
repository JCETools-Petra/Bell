...
@section('seo_title', 'Contact Us - Sora Hotel Merauke')
@section('meta_description', 'Hubungi Sora Hotel Merauke untuk reservasi kamar, MICE, atau restoran. Kami siap melayani kebutuhan Anda 24 jam.')
...
@section('content')
    ...
    <div class="relative bg-gray-900 min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            <span class="text-brand-secondary font-bold uppercase tracking-widest text-sm mb-2 block animate-fade-in-up">Get In Touch</span>
            <h1 class="text-4xl md:text-6xl font-heading font-bold text-white mb-6 tracking-tight animate-fade-in-up delay-100">
                Hubungi <span class="text-brand-secondary">Kami</span>
            </h1>
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 mb-16">
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="bg-gray-900 p-10 sm:p-12 text-white flex flex-col justify-between relative overflow-hidden">
                        <div class="absolute top-0 right-0 -mr-10 -mt-10 w-40 h-40 bg-brand-gold rounded-full opacity-20 blur-3xl"></div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="space-y-8">
                                <div class="flex items-start gap-4">
                                    <div class="w-12 h-12 rounded-full bg-gray-800 flex items-center justify-center flex-shrink-0 text-brand-gold">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:{{ preg_replace('/[^0-9]/', '', $settings['contact_phone'] ?? '') }}" class="text-white font-bold hover:text-brand-gold transition-colors text-lg">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:{{ $settings['contact_email'] ?? 'info@bellhotel.com' }}" class="text-white hover:text-brand-gold transition-colors">
                        ...
                        <div class="relative z-10 mt-12">
                            ...
                            <div class="flex gap-4">
                                ...
                                <a href="{{ $settings['contact_instagram'] }}" class="w-10 h-10 rounded-full bg-gray-800 hover:bg-brand-gold hover:text-gray-900 flex items-center justify-center transition-all">
                                    <i class="fab fa-instagram"></i>
                                </a>
                                @endif
                                @if(!empty($settings['contact_facebook']))
                                <a href="{{ $settings['contact_facebook'] }}" class="w-10 h-10 rounded-full bg-gray-800 hover:bg-brand-gold hover:text-gray-900 flex items-center justify-center transition-all">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                                @endif
                                @if(!empty($settings['contact_youtube']))
                                <a href="{{ $settings['contact_youtube'] }}" class="w-10 h-10 rounded-full bg-gray-800 hover:bg-brand-gold hover:text-gray-900 flex items-center justify-center transition-all">
                        ...
                        <form onsubmit="event.preventDefault(); sendToWhatsapp();" class="space-y-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" id="firstName" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors" placeholder="John">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Nama Belakang</label>
                                    <input type="text" id="lastName" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors" placeholder="Doe">
                                </div>
                            </div>

                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Email Address</label>
                                <input type="email" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors" placeholder="john@example.com">
                            </div>

                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Subjek</label>
                                <select id="subject" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors">
                            ...
                            <div>
                                ...
                                <textarea id="message" rows="4" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-brand-gold focus:border-brand-gold transition-colors" placeholder="Tulis pesan Anda di sini..."></textarea>
                            </div>

                            <button type="submit" class="w-full bg-gray-900 hover:bg-brand-gold text-white hover:text-gray-900 font-bold py-3.5 rounded-lg transition-all duration-300 shadow-lg transform hover:-translate-y-1 flex items-center justify-center gap-2">
