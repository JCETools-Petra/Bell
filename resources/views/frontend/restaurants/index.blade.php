...
@section('seo_title', 'Dining & Restaurants - Sora Hotel Merauke')
...
@section('content')
    ...
    <div class="relative bg-gray-900 py-24 sm:py-32 overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span class="text-brand-secondary font-bold uppercase tracking-widest text-sm mb-2 block animate-fade-in-up">Exquisite Dining</span>
            <h1 class="text-4xl md:text-6xl font-heading font-bold text-white mb-6 tracking-tight animate-fade-in-up delay-100">
                Taste of <span class="text-brand-secondary">Luxury</span>
            </h1>
                ...
                @forelse($restaurants as $index => $restaurant)
                    ...
                    <div class="flex flex-col {{ $index % 2 == 0 ? 'lg:flex-row' : 'lg:flex-row-reverse' }} gap-8 lg:gap-16 items-center group">
                        ...
                        <div class="w-full lg:w-1/2 space-y-6">
                            <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 group-hover:text-brand-gold transition-colors">
                                {{ $restaurant->name }}
                            </h2>
                            ...
                            <div class="flex items-center gap-4 pt-2">
                                <a href="{{ route('restaurants.show', $restaurant->slug ?? $restaurant->id) }}" 
                                   class="inline-flex items-center justify-center px-6 py-3 bg-gray-900 hover:bg-brand-gold text-white hover:text-gray-900 font-bold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                                    Lihat Menu & Detail
                                </a>
    ...
    <section class="py-20 bg-yellow-50 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
            ...
            <a href="{{ route('contact.index') }}" class="inline-flex items-center gap-2 bg-white border border-gray-200 hover:border-brand-gold text-gray-900 hover:text-brand-gold font-bold py-3 px-8 rounded-full shadow-sm hover:shadow-md transition-all">
