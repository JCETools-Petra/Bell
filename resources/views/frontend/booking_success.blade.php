...
@section('seo_title', 'Booking Berhasil - Sora Hotel Merauke')
            ...
            <div class="max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 relative">
                ...
                <div class="p-10 text-center">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-6 border border-gray-200 text-left">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900">
                                    @if($booking->payment_method == 'pay_at_hotel')
                                        <span class="flex items-center gap-1 text-brand-gold"><i class="fas fa-hand-holding-usd"></i> Bayar di Hotel</span>
                                    @else
                    ...
                    <div class="mt-8 space-y-3">
                        <a href="{{ route('home') }}" class="inline-flex items-center justify-center w-full bg-gray-900 hover:bg-brand-gold text-white hover:text-gray-900 font-bold py-3.5 rounded-xl transition-all shadow-lg transform hover:-translate-y-1">
                            Kembali ke Beranda
                        </a>
