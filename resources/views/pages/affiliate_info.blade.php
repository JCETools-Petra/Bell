...
@section('meta_description', 'Pelajari lebih lanjut tentang program afiliasi Sora Hotel Merauke dan bagaimana Anda bisa mendapatkan komisi.')
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4 p-md-5">
                        <h1 class="display-5 mb-4">Program Afiliasi Sora Hotel Merauke</h1>
