...
@section('seo_title', 'Terms & Conditions - ' . ($settings['website_title'] ?? 'Sora Hotel Merauke'))
@section('meta_description', 'Syarat dan Ketentuan penggunaan layanan Sora Hotel Merauke. Harap baca dengan seksama sebelum melakukan pemesanan.')

@section('content')
    {{-- 1. HERO HEADER --}}
    <div class="relative bg-gray-900 pt-32 pb-20 sm:pt-40 sm:pb-24 overflow-hidden">
        <div class="absolute inset-0 z-0 opacity-20">
             <div class="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-brand-gold rounded-full blur-3xl"></div>
             <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 bg-admin-secondary rounded-full blur-3xl"></div>
        </div>
        
        <div class="container mx-auto px-4 relative z-10 text-center">
            <span class="text-brand-gold font-bold uppercase tracking-[0.2em] text-sm mb-4 block animate-fade-in-up">Legal Information</span>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="bg-yellow-50 px-8 py-4 border-b border-yellow-100 flex items-center gap-3">
                    <i class="fas fa-file-contract text-brand-gold text-xl"></i>
