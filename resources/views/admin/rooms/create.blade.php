                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="create-room-form" action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="progress-container" class="w-full bg-gray-200 rounded-full h-2.5 my-4 hidden">
                            <div id="progress-bar" class="bg-admin-secondary h-2.5 rounded-full text-center text-white text-xs" style="width: 0%"></div>
                        </div>
                        ...
                        <div>
                            ...
                            <button type="submit" id="submit-button" class="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-admin-secondary">Save Room</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            form.addEventListener('submit', function (event) {
                ...
                axios.post(form.action, formData, config)
                    .then(function (response) {
                        ...
                        progressBar.classList.remove('bg-admin-secondary');
