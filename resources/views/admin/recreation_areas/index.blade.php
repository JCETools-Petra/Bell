                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($area->images->isNotEmpty())
                                            @php
                                                $imagePath = $area->images->first()->path;
                                            @endphp
                                            {{-- PERBAIKAN: Cek path agar tidak error (double storage) --}}
                                            <img src="{{ Str::contains($imagePath, 'storage/') ? asset($imagePath) : asset('storage/' . str_replace('public/', '', $imagePath)) }}" 
                                                 alt="{{ $area->name }}" 
