            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.mice.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="button" id="add-specification" class="mt-4 px-4 py-2 bg-admin-secondary text-white rounded-md hover:bg-blue-700">Add Layout</button>
        ...
        function addSpecificationRow() {
            ...
            newRow.innerHTML = `
                ...
                <div class="md:col-span-1 pt-6">
                    <button type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-brand-red rounded-lg hover:bg-red-700 remove-specification">Remove</button>
                </div>
            `;
