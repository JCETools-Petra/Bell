...
class PageController extends Controller
{
    public function terms()
    {
        ...
        // PERBAIKAN: Tambahkan 'frontend.' di depan path view
        return view('frontend.pages.terms', ['content' => $termsContent]);
    }
    ...
    public function affiliateInfo()
    {
        ...
        // PERBAIKAN: Tambahkan 'frontend.' di depan path view
        return view('frontend.pages.affiliate_info', ['content' => $affiliateContent]);
    }
}