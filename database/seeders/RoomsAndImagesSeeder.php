    ...
    public function run(): void
    {
        ...
        DB::table('rooms')->insert([
            [
                ...
                'slug' => 'superior',
                'price' => 450000.00,
                'description' => 'Kamar Standard di Sora Hotel Merauke dirancang untuk memberikan kenyamanan dengan fasilitas modern yang sesuai untuk perjalanan bisnis maupun liburan.',
